...
Write a function that takes a list of numbers and counts the amount of
...
def tripletCounter(nList):
    # Takes in a list of numbers. Returns the total number of triplets in it.
    count = 0
    for i in range(len(nList)-2):
        # Iteration. -2 is for error handling.
